                    ...
                    if (comp.getName().equals("Hat Switch")) {
                        ...
                        if (comp.getName().equals("Button 1") && value == 1.0f){
                           // System.out.println("A pressed");
                            ...
                            gamePad.left_trigger = true;
                        } else if (comp.getName().equals("Button 6")) {
                            //System.out.println("left trigger unpressed");
                            gamePad.left_trigger = false;
                        } else if (comp.getName().equals("Button 7") && value == 1.0f) {
                            //System.out.println("right trigger pressed");
                            gamePad.right_trigger = true;
                        } else if (comp.getName().equals("Button 7")) {
                            //System.out.println("right trigger unpressed");
                            gamePad.right_trigger = false;
                        }
